...
[![CI](https://img.shields.io/github/actions/workflow/status/ricardothesillyllama/Decanter/ci.yml?branch=main&style=flat-square&label=920%20checks)](https://github.com/ricardothesillyllama/Decanter/actions/workflows/ci.yml)
...
external dependencies — every dependency is a future 404. **920 checks** run in
